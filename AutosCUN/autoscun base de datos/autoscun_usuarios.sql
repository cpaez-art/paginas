...
CREATE TABLE `usuarios` (
  ...
  `USR_CLAVE` varchar(25) DEFAULT NULL,
  `USR_FECHA` date NOT NULL,
  `USR_ROL` varchar(10) NOT NULL
...
INSERT INTO `usuarios` VALUES (1,'cpaez','1234','2019-04-28','Admin'),(2,'ogongora','1234','2019-04-12','Cajero');
